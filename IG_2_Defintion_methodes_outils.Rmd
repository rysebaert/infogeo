...
Il s'agit de **l'ensemble des informations relatives à un objet géographique**, qui **le décrivent** et **le caractérisent**. Elles sont souvent nommées **données attributaires**. Le niveau sémantique **n'est pas fixe** et se décline en une multitude de caractéristiques.
<br>
