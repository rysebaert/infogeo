...
.center[ *Compromis entre* information *et* démonstration ]
...
Une méthode adaptée pour des distributions **très dissymétriques**. Elle conssite à construire des classes dont l'étendue augmente (ou diminue) de plus en plus.
