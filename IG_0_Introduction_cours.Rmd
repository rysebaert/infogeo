...
<span style="font-size:19pt;">**2) Choisissez un type d'équipement public** parmi ces propositions :</span>
...
Les données géolocalisées de ces équipements ont préalablement été collectées par vos enseignants. Vous êtes libres de choisir d'autres équipements, mais il faudra récupérer vous-même ces données. 
