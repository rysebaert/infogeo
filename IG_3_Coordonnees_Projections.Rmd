...
- des **angles**, mesurées depuis le centre de la Terrre et vers un point de la surface 
...
- relatives à un **système géodésique** de référence (**l'éllipsoïde**).
]
...
Pour représenter une **surface sphérique** sur un **plan (planisphère)**, on utilise des **systèmes de projection cartogrpahiques** qui :
