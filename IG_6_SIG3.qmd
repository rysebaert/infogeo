...
subtitle: "Initiation aux géotraitements"
author:
  - name: "Louis Laurian"
...
::: columns
::: column
Consulter le fichier `socio_eco.csv`. Après avoir repéré le champ pertinent (`DEC_MED19`), importer cette couche de texte délimité dans QGIS.
